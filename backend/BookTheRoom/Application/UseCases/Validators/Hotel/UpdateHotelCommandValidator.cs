    ...
    public sealed class UpdateHotelCommandValidator : AbstractValidator<UpdateHotelCommand>
    {
        public UpdateHotelCommandValidator()
        {
            RuleFor(c => c.Request.Name)
                .NotEmpty().WithMessage("The hotel name cannot be empty.")
                .MaximumLength(100).WithMessage("The hotel name must not exceed 100 characters.");

            RuleFor(c => c.Request.Description)
                .NotEmpty().WithMessage("The description cannot be empty.")
                .MaximumLength(3000).WithMessage("The description must not exceed 3000 characters.");
