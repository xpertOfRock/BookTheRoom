...
{
    /// <summary>
    /// Interface which represents an abstraction for managing entities type of "Apartment" in database using Redis and Entity Framework with cache aside pattern.
    /// </summary>
